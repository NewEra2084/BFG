    ...
    return (
      ...
      >
        <div
          ...
          className={`list-items flex h-full ${is_answered && "ring-2 ring-green-800 outline-1"} flex-col rounded-xl`}
          onClick={(e) => {
            if (e.detail == 1) {
              ...
              <AlertDialogCustom
                ...
                description={
                  <p>
                    ...
                    <span className="text-red/90"> StackOverflow.com</span>,
                    сайт не несет ответственности за его действия.
                  </p>
                }
              />
            </div>
